    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav className="mb-6 text-sm text-muted-foreground">
          <Link href="/zh-CN/schools" className="hover:text-primary">
            学校列表
          </Link>
        ...
        <div className="mb-8">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {school.isFeatured && (
              <Badge className="bg-primary">精选</Badge>
            )}
          </div>
          <h1 className="mt-3 text-3xl font-bold sm:text-4xl">
            {school.nameZh}
          </h1>
          <p className="mt-1 text-lg text-muted-foreground">{school.nameJa}</p>
          {school.prefecture && (
          ...
          {firstYearTotal > 0 && (
            <div className="mt-4 flex flex-wrap gap-4">
              ...
              {school.commissionAmount && (
                <div className="rounded-lg bg-transparent-red-muted px-4 py-2">
                  <span className="text-sm text-muted-foreground">平台佣金</span>
                  <p className="text-xl font-bold text-transparent-red">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="location">
            <div className="space-y-4">
              ...
              {school.latitude && school.longitude && (
                <div className="overflow-hidden rounded-lg border bg-muted/50 p-12 text-center text-muted-foreground">
                  <p>地图功能开发中</p>
        ...
        <div className="mt-12 space-y-6">
          {/* 流程条：参考 partylabel 的 1~4 步 */}
          <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-white/[0.06] via-white/[0.02] to-transparent px-4 py-5 sm:px-6">
      ...
      {/* 右侧固定操作栏（桌面端） */}
      <div className="fixed right-4 top-28 z-40 hidden w-60 flex-col gap-3 lg:flex">
        <div className="rounded-2xl border border-primary/40 bg-background/95 p-4 shadow-[0_0_28px_rgba(15,23,42,0.85)] backdrop-blur-xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-background/95 p-4 text-xs text-muted-foreground backdrop-blur-xl">
          <p className="font-semibold text-foreground">平台礼遇提醒</p>
          <p className="mt-1">
            通过平台完成入学，可享行前日语体验课、材料预检查等礼遇，具体以顾问确认为准。
          </p>
          <Link href="/zh-CN/process" className="mt-2 inline-block text-[11px] text-primary hover:underline">
            查看完整流程
          </Link>
        </div>
      </div>
